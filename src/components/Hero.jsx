    ...
    <section className="relative bg-gradient-to-r from-blue-50 to-purple-50 overflow-hidden py-28">
      ...
      <div className="container mx-auto px-6 lg:px-20 flex flex-col items-center text-center gap-8">
        ...
        <motion.h1
          ...
          className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 leading-tight"
        >
        ...
        <motion.p
          ...
          className="text-gray-700 dark:text-gray-300 text-lg md:text-xl max-w-3xl"
        >
